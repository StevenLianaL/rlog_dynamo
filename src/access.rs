...
impl LogAccess {
    ...
    pub async fn increase(&self, app: &str, action: &str) {
        ...
        expression_attribute_names.insert("#p".to_string(), "project".to_string());
        ...
        expression_attribute_values.insert(":project".to_string(), AttributeValue::S(self.project.to_string()));
        ...
        self.client
            ...
            .set_key(Some(key))
            .update_expression("SET #c = if_not_exists(#c, :start) + :inc, #a = :app, #m = :month, #p = :project")
